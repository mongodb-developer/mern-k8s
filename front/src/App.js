...
export default function App() {
  ...
  return (
    <header>
        ...
        <div className='mask' style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}>
          <div className='d-flex justify-content-center align-items-center h-100'>
            <div className='text-white'>
              <h1 className='mb-3'>Mini Travel Planner 🏖️</h1>
              <h4 className='mb-3'>Plan your next adventure, hassle free!</h4>
              
              <MDBInput label='Author:' id='formTextExample1' contrast type='text' aria-describedby='textExample1' value={author} onChange={e => setAuthor(e.target.value)} />
      ...
      <MDBInput label='Lat + Long:' id='formTextExample1' contrast type='text' aria-describedby='textExample1' value={lat} onChange={e => setLat(e.target.value)} />
      <div id='textExample1' className='form-text'></div>

      <MDBInput label='Link' id='formTextExample1' contrast type='text' aria-describedby='textExample1' value={link} onChange={e => setLink(e.target.value)} />
      <div id='textExample1' className='form-text' ></div>
              <br></br>
